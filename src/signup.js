...
useState(() => {
  ...
  const validate = () => {
    ...
    if (!agree) newErrors.agree = "You must accept the Terms & Conditions";
    setErrors(newErrors);
  ...
  const allFilled = Object.values(form).every((v) => v.trim() !== "") && agree;
  ...
  return (
    <div style={formContainer}>
      ...
      <button
        ...
        style={{ ...btnStyle, opacity: allFilled ? 1 : 0.6 }}
        disabled={loading}
      >
